...
/**
 * Function added to allow custom SPI wirering
 * call this function before "PCD_Init()" to config SPI lines
 * with your desired SPIClass
 */
void MFRC522::SPI_Config(SPIClass userSpi ///< Specific SPIClass
								){
